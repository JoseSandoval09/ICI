...
2ndo Parcial
   ...
   De acuerdo a las ï¿½ltimas restricciones, solicitadas del cruzamiento en el que se debieron de elegir 6 al azar en cada generaciï¿½n y realizar 
   ...
   realizar la mutaciï¿½n DE ACUERDO A LO QUE SE SOLICITA:

	DESPUï¿½S DE ORDENAR EN LA PRIMER GENERACIï¿½N USANDO CRUZAMIENTO, SE LE AGREGARï¿½ EN CADA GENERACIï¿½N UNA MUTACIï¿½N, COMO SIGUE:

		a) Tomando como restricciï¿½n los ï¿½ltimos 5 individuos, elegir 2 individuos al azar, que serï¿½a equivalente al 20% de la poblaciï¿½n.
		b) Generar para cada individuo seleccionado (de los dos), un porcentaje del 10 al 40%, para elegir con su porcentaje el cambio(mutaciï¿½n) 
			del bit( 0 cambia a 1, ï¿½ 1 cambia a 0); si se generï¿½
		...
		d) Volver a ordenar y repetir la acciï¿½n para cada generaciï¿½n
*/
...
int main (){
	// Variables numericas
	int i,j,k,g,c,m,sep,pA,pa,aux,mut1,mut2,per,m1,m2,m3,m4,M1,M2,M3,M4,v,fin,fm;
