...
void mut (poblacion cadena[],poblacion mutacion,int cadena_mutar, int porcentaje){ // MUTACIONES
	if (porcentaje>=1){ /*10%*/
		if (cadena[cadena_mutar-1].bits[mutacion.bits[0]-1] == 0){
			cadena[cadena_mutar-1].bits[mutacion.bits[0]-1] = 1;
		}else{
			cadena[cadena_mutar-1].bits[mutacion.bits[0]-1] = 0;
		}
	}
	if (porcentaje>=2){ /*20%*/
		if (cadena[cadena_mutar-1].bits[mutacion.bits[1]-1] == 0){
			cadena[cadena_mutar-1].bits[mutacion.bits[1]-1] = 1;
		}else{
			cadena[cadena_mutar-1].bits[mutacion.bits[1]-1] = 0;
		}
	}
	if (porcentaje>=3){ /*30%*/
		if (cadena[cadena_mutar-1].bits[mutacion.bits[2]-1] == 0){
			cadena[cadena_mutar-1].bits[mutacion.bits[2]-1] = 1;
		}else{
			cadena[cadena_mutar-1].bits[mutacion.bits[2]-1] = 0;
		}
	}
	if (porcentaje>=4){ /*40%*/
		if (cadena[cadena_mutar-1].bits[mutacion.bits[3]-1] == 0){
			cadena[cadena_mutar-1].bits[mutacion.bits[3]-1] = 1;
		}else{
			cadena[cadena_mutar-1].bits[mutacion.bits[3]-1] = 0;
		}
	}
}