...
x<- r:8 #valores posibles de 3 a 8
fx<- choose(n=x-1,k=2)*p^r*(1-p)^(x-r)
sum(fx)

pnbinom(q=8-r,size=r,prob=p)    # OJO con esta linea/ negativa binomial siempre quiere empezar en 0 por eso q=8-r


#pnbinom(q=3-r,size=r,prob=p)    # OJO con esta linea/ negativa binomial siempre quiere empezar en 0 por eso q=8-r
