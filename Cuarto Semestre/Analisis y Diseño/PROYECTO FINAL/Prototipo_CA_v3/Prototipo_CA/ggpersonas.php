...
<?php 
    ...
    if ($result = $enlace->query($query)){
        while($r = $result->fetch_assoc()){
            ...
            echo '<td>';
            echo "<form action='ggPersona.php' method='delete'>";
            ...
            echo "<input type='hidden' name='id' value='",$r['ID'],"'>";
            echo "<input class='btn btn-secondary ms-3' type='button'  name='update' value='Modificar' data-bs-toggle='modal' data-bs-target='#ModificarGrupopersona'>";
            echo "</form>";
            echo'</td>';
...
<!-- Modal -->
<div class="modal fade" id="ModificarGrupopersona" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
