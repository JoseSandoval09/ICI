...
<div class="container text-center text-primary">
        <div class="container">
          <h2>Gestionar Grupo de Puertas</h2>
        </div>
...
<!-- Button  modal -->
  ...
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModificarGrupoPuertas">
    Modificar Grupo
  </button>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <form class="row g-3" action="ggPuertas.php" method="post">   
                    <div class="col-md-6">
...
<!-- Modal -->
<div class="modal fade" id="ModificarGrupoPuertas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
...
<?php 
    ...
    if (isset($_POST['nombre']) && isset($_POST['descripcion'])) {
        ...
        $sql = "INSERT INTO grupopuerta (Nombre,Descripcion) VALUES ('$nombre', '$descripcion')";
...
<?php
  ...
  if (isset($_POST['id-actualizar']) && isset($_POST['nombre-actualizar']) && isset($_POST['descripcion-actualizar'])) {
      ...
      ;
      $sql = "UPDATE grupopuerta SET Nombre = '$nombre', Descripcion = '$descripcion' WHERE id = $id";
