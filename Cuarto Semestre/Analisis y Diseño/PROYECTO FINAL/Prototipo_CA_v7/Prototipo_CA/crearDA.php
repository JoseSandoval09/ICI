...
<?php 
    ...
    if ($result = $enlace->query($query)){
        while($r = $result->fetch_assoc()){
            ...
            echo '</td>';
            echo '<td>';
            echo "<form action='crearDA.php' method='put'>";
            echo "<input type='hidden' name='id' value='",$r['ID'],"'>";
            echo "<input class='btn btn-secondary' type='button' name='update' value='Modificar' data-bs-toggle='modal' data-bs-target='#ModificarAcceso'>";
            echo "</form>";
            echo'</td>';
            echo '</tr>';
        }//fin while filas
...
<?php
  ...
  if (isset($_POST['id-actualizar']) && isset($_POST['diasem-actualizar']) && isset($_POST['horaini-actualizar']) && isset($_POST['minuini-actualizar']) && isset($_POST['horafin-actualizar']) && isset($_POST['minufin-actualizar']) && isset($_POST['grupopersonaId-actualizar']) && isset($_POST['grupopuertaId-actualizar'])) {
    ...
    $grupopuertaID = $_POST['grupopuertaId-actualizar'];
      ...
      $sql = "UPDATE accesosemana SET DiaSemana = '$dia', HoraInicio = '$hi', MinutoInicio = '$mi', HoraFin = '$hf', MinutoFin = '$mf', FKIdGrupoPersona = 'grupopersonId-actualizar', FKIdGrupoPuerta = 'grupopuertaId-actualizar' WHERE id = $id";
