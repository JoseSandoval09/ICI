...
Proceso Sucursales
   ...
   Para I<-{1#0} Hasta {5#4} Hacer
      Escribir 'Ingrese Precio Articulo ',{I#I+1},':'{;}
      Leer Prec[I]{;}
   FinPara
   ...
   Para J<-{1#0} Hasta {4#3} Hacer
      Para I<-{1#0} Hasta {5#4} Hacer
         Escribir 'Ingrese Cant. de Articulo ',{I#I+1},', en Sucursal ',{J#J+1},':'{;}
         Leer Cant[J,I]{;}
      FinPara
   FinPara
   ...
   Para I<-{1#0} Hasta {5#4} Hacer
      ...
      Escribir 'Total articulo ',{I#I+1},':',Suma{;}
   FinPara
   ...
   Escribir 'Sucursal 1, Articulo 3:',Cant[{1,3#0,2}]{;}
